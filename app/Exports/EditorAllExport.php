...
class EditorAllExport implements FromCollection, WithHeadings, WithStyles, WithEvents, WithCustomStartCell
{
    /**
        ...
        return Editor::with(['data'])
            ...
            ->map(function ($editor, $index) {
                ...
                return [
                    ...
                    'journals' => $editor->journal->pluck('name')->implode(', '),
                    'total_journals' => $editor->journal->count(),
                ];
            });
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'LAPORAN DATA EDITOR');
