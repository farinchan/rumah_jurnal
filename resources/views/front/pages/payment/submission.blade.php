...
@section('seo')
    ...
    <meta property="og:url" content="{{ route('payment.submission', [$journal->url_path, $submission->submission_id]) }}">
    <link rel="canonical" href="{{ route('payment.submission', [$journal->url_path, $submission->submission_id]) }}">
