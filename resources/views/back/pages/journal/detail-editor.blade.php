                    ...
                    <div class="card-body">
                        ...
                        @if ($file_sk)
                            <div class="btn-group w-100 mb-5">
                                ...
                                <a href="{{ route('back.journal.editor.file-sk.send-mail', [$journal->url_path, $issue->id]) }}" class="btn btn-light-success" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="card-body">
                        ...
                        @if ($file_certificate)
                            <div class="btn-group w-100 mb-5">
                                ...
                                <a href="{{ route('back.journal.editor.file-certificate.send-mail', [$journal->url_path, $issue->id]) }}" class="btn btn-light-success" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="card-body">
                        ...
                        @if ($file_fee)
                            <div class="btn-group w-100 mb-5">
                                ...
                                <a href="{{ route('back.journal.editor.file-fee.send-mail', [$journal->url_path, $issue->id]) }}" class="btn btn-light-success" data-bs-toggle="tooltip" data-bs-placement="top"
