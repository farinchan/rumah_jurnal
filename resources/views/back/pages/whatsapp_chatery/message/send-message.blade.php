...
@section('content')
    ...
    <div id="kt_content_container" class=" container-xxl ">
        @include('back.pages.whatsapp_chatery.message.header')
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="kt_tab_pane_8" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form id="kt_modal_create_discipline_rule_form2" class="form" method="POST">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#kt_modal_create_discipline_rule_form2').submit(function(e) {
                $('#send_message_btn2').attr('disabled', true);
                $('#send_message_btn2').html(
                    '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...'
                );
                e.preventDefault();
                var formData = new FormData(this);
            ...
            $.ajax({
                url: "{{ route('api.whatsapp.send-message') }}",
                type: 'POST',
                data: formData,
