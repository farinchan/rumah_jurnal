                    ...
                    <div class=" hover-scroll-x">
                        <div class="d-grid">
                            <ul class="nav nav-tabs flex-nowrap text-nowrap">
                                @role('super-admin|admin-ejournal')
                                    <li class="nav-item">
                                ...
                                @endrole
                                @role('super-admin|admin-proceeding')
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0"
                                            data-bs-toggle="tab" href="#kt_tab_pane_2">Proceeding</a>
                                    </li>
                                @endrole
                                @role('super-admin|admin-student-research-hub')
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0"
                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('back.master.journal.update', $journal->id) }}"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-5">
                                <label class="form-label">Akreditasi & Indexing Jurnal</label>
                                <div class="row">
                                    <div class="col-md-4">
