                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="kt_ecommerce_settings_store" role="tabpanel">
                        <form id="kt_ecommerce_settings_general_store" class="form"
                            action="{{ route('back.setting.website.update') }}" method="POST"
                                ...
                                <div class="col-md-9">
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                        ...
                                        <label
                                            ...
                                            data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Ganti Logo">
                    ...
                    <div class="tab-pane fade " id="kt_ecommerce_settings_general" role="tabpanel">
                        <form id="kt_ecommerce_settings_general_form" class="form"
                            action="{{ route('back.setting.website.info') }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row mb-7">
                                <div class="col-md-9 offset-md-3">
