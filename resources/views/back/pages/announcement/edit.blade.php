...
<div id="kt_content_container" class=" container-xxl ">
            ...
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                action="{{ route('back.announcement.update', $announcement->id) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="title" class="form-control mb-2" placeholder="Judul pengumuman"
                            ...
                            <div class="mb-10">
                                ...
                                <div class="text-muted fs-7">
                                    File pengumuman, Hanya menerima file dengan ekstensi <code>.pdf</code> , dengan ukuran
                                    maksimal 8 MB
                                </div>
                                @if ($announcement->file)
                                    <div class="text-muted fs-7">
                                        File Lampiran Sebelumnya : <a href="{{ $announcement->getFile() }}" target="_blank">
                                            {{ $announcement->getFile() }} </a>, kosongkan jika tidak ingin mengganti file
                                    </div>
                                @endif
                            </div>
                            <div>
                                ...
                                <input id="keyword_tagify" name="meta_keywords" class="form-control mb-2"
                                    value="{{ $announcement->meta_keywords }}" />
                                @error('meta_keywords')
                                    <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                                <div class="text-muted fs-7">
