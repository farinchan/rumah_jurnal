                        ...
                        <div style="text-align:left; margin-bottom:54px">
                            ...
                            <div
                                ...
                                <p style="margin-bottom:2px; color:#3F4254; line-height:1.6">
                                    ...
                                    Please find the attached file of the reviewer's appointment letter (SK) for your
                                    reference. This letter pertains from the journal <strong>"{{ $mailData['journal'] }}"</strong> and
                                    the edition <strong>"{{ $mailData['edition'] }}"</strong>.
                                    <br>
                                    <br>
