                        ...
                        <div style="text-align:left; margin-bottom:54px">
                            ...
                            <div
                                ...
                                <p style="margin-bottom:2px; color:#3F4254; line-height:1.6">
                                    ...
                                    We are pleased to inform you that your article titled
                                    <strong>
                                        "{{ $mailData['title'] }}"
                                    </strong> has been accepted for publication in the journal
                                    <strong>
                                        {{ $mailData['journal'] }} in the {{ $mailData['edition'] }} Edition.
                                    </strong>
                                    <br>
                                    <br>

                                    As part of the publication process, we have attached the <strong>Letter of Acceptance
                                        (LoA)</strong> for your review.
                                    <br>
                                    <br>

                                    If there is anything that needs clarification or if you have any questions, please do not hesitate to contact us.
                                    <br>

                                    Thank you for your attention and cooperation. We greatly appreciate your contribution to our journal.
