                        ...
                        <div style="text-align:left; margin-bottom:54px">
                            ...
                            <div
                                ...
                                <p style="margin-bottom:2px; color:#3F4254; line-height:1.6">
                                    Thank you for your valuable contribution to our journal. We are pleased to inform you
                                    that the payment for your review services has been processed successfully.

                                    <br>
                                    <br>

                                    Please find the attached proof of payment for your reference. This payment pertains
                                    to the journal <strong>"{{ $mailData['journal'] }}"</strong> and the edition
                                    <strong>"{{ $mailData['edition'] }}"</strong>.
                                    <br>
                                    <br>
                                    Your expertise and dedication are greatly appreciated, and we look forward to your
                                    continued support in maintaining the quality and integrity of our publication.
